	...
	class wm_subnav extends WP_Widget {
		...
		function __construct() {
			...
			//Helper variables
				...
				$atts['id']          = 'wm-subnav';
				$atts['name']        = WM_THEME_NAME . ' ' . __( 'Submenu', 'wm_domain' );
				...
				$atts = apply_filters( 'wmhook_custom_widget_atts_' . 'wm_subnav', $atts );
		...
		function form( $instance ) {
			...
			//Output
				...
				do_action( 'wmhook_wm_subnav_form', $instance );
		...
		function update( $new_instance, $old_instance ) {
			...
			//Output
				return apply_filters( 'wmhook_wm_subnav_instance', $instance, $new_instance, $old_instance );
		...
		function widget( $args, $instance ) {
			...
			//Output
				echo apply_filters( 'wmhook_wm_subnav_output', $output, $args, $instance );
