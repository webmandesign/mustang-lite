	...
	class wm_tabbed_widgets extends WP_Widget {
		...
		function __construct() {
			...
			//Helper variables
				...
				$atts['name']        = WM_THEME_NAME . ' ' . __( 'Tabbed Widgets', 'wm_domain' );
				...
				$atts = apply_filters( 'wmhook_custom_widget_atts_' . 'wm_tabbed_widgets', $atts );
		...
		function form( $instance ) {
			...
			//Output
				...
				do_action( 'wmhook_wm_tabbed_widgets_form', $instance );
		...
		function update( $new_instance, $old_instance ) {
			...
			//Output
				return apply_filters( 'wmhook_wm_tabbed_widgets_instance', $instance, $new_instance, $old_instance );
