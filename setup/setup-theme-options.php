				 ...
				 */
					...
					//Support table content
						$support_table_content = '
							<thead>
								<tr>
									<th colspan="2">' . __( 'WordPress and Theme', 'mustang-lite' ) . '</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<th>' . __( 'WP Version', 'mustang-lite' ) . ':</th>
									<td>' . get_bloginfo( 'version' ) . '</td>
								</tr>
								<tr>
									<th>' . __( 'WP Multisite Enabled', 'mustang-lite' ) . ':</th>
									<td>' . ( ( is_multisite() ) ? ( __( 'Yes', 'mustang-lite' ) ) : ( __( 'No', 'mustang-lite' ) ) ) . '</td>
								</tr>
								<tr>
									<th>' . __( 'WP Language', 'mustang-lite' ) . ':</th>
									<td>' . ( ( defined( 'WPLANG' ) && WPLANG ) ? ( WPLANG ) : ( __( 'Default', 'mustang-lite' ) ) ) . '</td>
								</tr>
								<tr>
									<th>' . __( 'Home URL', 'mustang-lite' ) . ':</th>
									<td>' . home_url() . '</td>
								</tr>
								<tr>
									<th>' . __( 'Site URL', 'mustang-lite' ) . ':</th>
									<td>' . site_url() . '</td>
								</tr>
								<tr>
									<th>' . __( 'Theme Name', 'mustang-lite' ) . ':</th>
									<td>' . WM_THEME_NAME . '</td>
								</tr>
								<tr>
									<th>' . __( 'Theme Shortname', 'mustang-lite' ) . ':</th>
									<td>' . WM_THEME_SHORTNAME . '</td>
								</tr>
								<tr>
									<th>' . __( 'Theme Version', 'mustang-lite' ) . ':</th>
									<td>' . WM_THEME_VERSION . '</td>
								</tr>
								<tr>
									<th>' . __( 'WP Debug Mode', 'mustang-lite' ) . ':</th>
									<td>' . ( ( defined( 'WP_DEBUG' ) && WP_DEBUG ) ? ( __( 'Yes', 'mustang-lite' ) ) : ( __( 'No', 'mustang-lite' ) ) ) . '</td>
								</tr>
								<tr>
									<th>' . __( 'WP Memory Limit', 'mustang-lite' ) . ':</th>
									<td>' . WP_MEMORY_LIMIT . '</td>
								</tr>
								<tr>
									<th>' . __( 'WP Max Upload Size', 'mustang-lite' ) . ':</th>
									<td>' . size_format( wp_max_upload_size() ) . '</td>
								</tr>
							</tbody>
							<thead>
								<tr>
									<th colspan="2">' . __( 'Server Info', 'mustang-lite' ) . '</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<th>' . __( 'Web Server Info', 'mustang-lite' ) . ':</th>
									<td>' . esc_html( $_SERVER['SERVER_SOFTWARE'] ) . '</td>
								</tr>
								<tr>
									<th>' . __( 'PHP Version', 'mustang-lite' ) . ':</th>
									<td>' . ( ( function_exists( 'phpversion' ) ) ? ( esc_html( phpversion() ) ) : ( '-' ) ) . '</td>
								</tr>
								<tr>
									<th>' . __( 'MySQL Version', 'mustang-lite' ) . ':</th>
						...
						if ( function_exists( 'ini_get' ) ) {
							$support_table_content .= '
									<tr>
										<th>' . __( 'PHP memory_limit', 'mustang-lite' ) . ':</th>
										<td>' . ini_get( 'memory_limit' ) . '</td>
									</tr>
									<tr>
										<th>' . __( 'PHP post_max_size', 'mustang-lite' ) . ':</th>
										<td>' . ini_get( 'post_max_size' ) . '</td>
									</tr>
									<tr>
										<th>' . __( 'PHP upload_max_filesize', 'mustang-lite' ) . ':</th>
										<td>' . ini_get( 'upload_max_filesize' ) . '</td>
									</tr>
									<tr>
										<th>' . __( 'PHP max_execution_time', 'mustang-lite' ) . ':</th>
										<td>' . ini_get( 'max_execution_time' ) . '</td>
									</tr>
									<tr>
										<th>' . __( 'PHP max_input_vars', 'mustang-lite' ) . ':</th>
					...
					//Setting $help_texts array
						$help_texts['themes'] = array(
								array(
									'tab-id'      => 'wm-support',
									'tab-title'   => __( 'Support and troubleshooting', 'mustang-lite' ),
									'tab-content' => '<p>' . sprintf( __( 'If you have any difficulties with the theme or need a help customizing it, please visit the %s.<br />The troubleshooting information below may be requested by support staff to resolve your query. Please, provide them when asked.', 'mustang-lite' ), '<a href="' . WM_SUPPORT_URL . '/forums/forum/' . WM_THEME_SHORTNAME . '" target="_blank">WebMan Support Forum</a>' )  . '</p><table class="wm-table">' . $support_table_content . '</table>',
								)
							);
